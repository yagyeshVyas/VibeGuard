...
const scanLines: { text: string; cls: string; delay: number }[] = [
  ...
  { text: "./my-app", cls: "text-[#4a7a8a]", delay: 500 },
  { text: "", cls: "", delay: 600 },
  { text: "CRITICAL  api/route.ts:3  [secret.openai-key]", cls: "text-[#ff3860] font-bold glow-text-red", delay: 800 },
  { text: "  OpenAI API key hardcoded in server code", cls: "text-[#5a8a9a]", delay: 950 },
  ...
  { text: "  User input flows into SQL query via template literal", cls: "text-[#5a8a9a]", delay: 1550 },
  ...
  { text: "  User input reaches innerHTML — DOM XSS", cls: "text-[#5a8a9a]", delay: 2150 },
...
export default function TerminalDemo() {
  ...
  return (
    <section ref={sectionRef} className="relative py-24 px-6 overflow-hidden">
      <div className="absolute inset-0 glow-green opacity-20" />
      <div className="relative max-w-4xl mx-auto">
        ...
        >
          ...
          <h2 className="font-tech text-3xl md:text-4xl font-bold text-white tracking-wide">
            SEE IT <span className="text-cyan-gradient glow-text-cyan">IN ACTION</span>
          </h2>
          <p className="mt-3 font-body text-[#5a8a9a]">A real scan of a test project with a planted Stripe key.</p>
        </motion.div>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className="hud-panel scanline-overlay overflow-hidden shadow-2xl shadow-[#00f0ff]/10"
        >
          {/* Terminal title bar */}
          <div className="flex items-center gap-2 px-4 py-3 border-b border-[#00f0ff]/10 bg-[#050a14]">
            ...
            <span className="ml-3 font-mono text-xs text-[#4a7a8a]">vibeguard — scan — 120×40</span>
