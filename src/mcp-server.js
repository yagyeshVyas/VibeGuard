 ...
 *   claude mcp add vibeguard -- npx -y vibeguard mcp
 * or, from a checkout:
...
const TOOLS = [
  ...
  },
  {
    ...
    description: 'Analyze AI agent session history for risky behavior patterns (blind approvals, high delegation, skipping tests).',
    inputSchema: DIR_SCHEMA,
  },
  {
    name: 'list_rules',
