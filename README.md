...
<strong>766 rules</strong> · <strong>83 MCP tools</strong> · <strong>18 languages</strong> · <strong>10 compliance frameworks</strong><br/>
...
<p>
  ...
  <img src="https://img.shields.io/badge/MCP%20tools-83-purple?style=flat-square" alt="83 MCP tools" />
...
- 🔌 **83 MCP tools all verified** — a live JSON-RPC stdio handshake + a new per-tool audit caught and fixed 3 crashes; **0 bugs**, 78 graceful. `scripts/mcp-audit-tools.js` now ships with the repo.
...
- ☸️ **IaC hardening (Kubernetes + Compose + Actions)** — catches privileged pods, `runAsUser: 0`, `hostNetwork`, `allowPrivilegeEscalation`, dangerous capabilities, auto-mounted service accounts, `docker.sock` mounts, `network_mode: host`, hardcoded compose secrets, `pull_request_target`, and `curl|sh` supply-chain piping. Closes the biggest gap vs. Trivy/Checkov/KubeLinter.
</details>
...
<!-- Rules: 766 | MCP Tools: 83 | Defense Layers: 13 -->
<!-- COUNTS:END -->
